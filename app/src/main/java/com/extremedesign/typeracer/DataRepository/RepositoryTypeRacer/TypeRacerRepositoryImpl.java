...
public class TypeRacerRepositoryImpl implements TypeRacerRepository {
    //    private IDataSource networkDataSource;
    private IDataSource databaseDataSource;
    private WeakReference<Context> contextWeakReference;

    public TypeRacerRepositoryImpl(Context context, IDataSource databaseDataSource) {
//        this.networkDataSource = networkDataSource;
    ...
    public void synchronizeProfileImages(final JobWorker listener) {
        FirebaseRepo.getFirebaseStorage().getReference().getRoot().child("images")
    ...
    public Bitmap loadImageBitmap(String imageName) {
        ...
        try {
            ...
            fiStream = contextWeakReference.get().openFileInput(imageName);
    ...
    public void saveImage(Bitmap b, String imageName) {
        ...
        try {
            foStream = contextWeakReference.get().openFileOutput(imageName, Context.MODE_PRIVATE);
